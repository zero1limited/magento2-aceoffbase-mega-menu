 ...
 */
namespace Zero1\AceOffBaseMegaMenu\Block\Html;
...
class Topmenu extends \Magento\Theme\Block\Html\Topmenu
{
     ...
     */
    protected function _addSubMenuWithCounter($child, $childLevel, $childrenWrapClass, $limit, $counter)
    {
        $html = '';
        ...
        if ($childLevel == 0) {
            $staticBlockId = 'z1-mega-menu-' . $counter;
            $html .= '<div id="' . $staticBlockId . '" class="z1-mega-menu-block z1-mega-menu-block-' . $counter . '">';
            $html .= $this->getLayout()->createBlock('Magento\Cms\Block\Block')->setBlockId($staticBlockId)->toHtml();
            $html .= '</div>';
        }
    ...
    protected function _getHtml(
        ...
        foreach ($children as $child) {
            ...
            $html .= '<a href="' . $child->getUrl() . '" ' . $outermostClassCode . '><span>' . $this->escapeHtml(
                $child->getName()
            ) . '</span></a>' . $this->_addSubMenuWithCounter(
                $child,
                $childLevel,
                $childrenWrapClass,
                $limit,
